...
import heroImage from "@/assets/primary-packaging/custom-pre-roll-tubes/custom-pre-roll-tubes-hero.webp";
...
const CustomPreRollTubes = () => {
    ...
    const productImages = [
        { src: customPreRollTubes, alt: "Custom Pre Roll Tubes - Premium" },
        { src: heroImage, alt: "Custom Pre Roll Tubes - Hero" },
        { src: paperTubes, alt: "Custom Pre Roll Tubes - Alternative 1" },
        { src: plasticCapsuleBottle, alt: "Custom Pre Roll Tubes - Alternative 2" },
        { src: customPreRollTubes, alt: "Custom Pre Roll Tubes - Main" },
    ];
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Pre Roll Tubes | Cannabis Packaging | CustomPackMakers</title>
                <meta name="description" content="Wholesale custom pre roll tubes for cannabis branding. Features certified child-resistant pop-top seals, opaque colors, and custom labeling." />
            </Helmet>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-16 items-start">
                        ...
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <p className="text-[16px] text-muted-foreground leading-relaxed line-clamp-4 px-4 lg:px-0">
                                Customizable pre-roll tubes for cannabis branding and protection, featuring certified child-resistant seals and UV-blocking opaque colors. Ensure your pre-rolls stay fresh, protected, and fully compliant.
                            </p>
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Compliant, Odor-Resistant Packaging for Cannabis Brands
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            In the rapidly expanding cannabis market, pre-rolls remain one of the most popular and accessible product categories. However, packaging pre-rolls presents unique challenges: the delicate joints must be protected from crushing, shielded from UV light to prevent terpene degradation, and housed in strictly certified child-resistant containers to meet complex state and federal regulatory compliance.
                        </p>
                        <p>
                            Our <strong className="text-foreground">custom pre-roll tubes</strong> (commonly known as doob tubes) are engineered to solve all of these challenges while providing a sleek canvas for your dispensary's branding. Manufactured from durable, medical-grade polypropylene (PP) or premium glass, our airtight tubes trap odors inside while keeping moisture out, ensuring the product smokes perfectly whether it's opened tomorrow or months down the line. 
                        </p>
                    </div>
                </div>
            </section>
            ...
            <TechnicalSpecsSection 
                title="Custom Pre Roll Tube Specifications"
                specsTableTitle="Primary Packaging Specs"
                specsTableHeader1="Property"
                specsTableHeader2="Details"
                specsRows={[
                    { label: "Standard Sizes", value: "90mm, 98mm, 116mm (King Size)" },
                    { label: "Material Options", value: "PP (Polypropylene) Plastic, Borosilicate Glass, Hemp Plastic" },
                    { label: "Closure Mechanism", value: "Pop-Top (Squeeze-to-Open), CRC Push-and-Turn Screw Cap" },
                    { label: "Compliance", value: "Certified Child-Resistant (CPSC & ASTM Compliant)" },
                    { label: "Compatibility", value: "Standard Pre-Rolls, Cones, Blunts, Vape Cartridges" }
                ]}
                materialTitle="Decoration & Finishing Options"
                materialList={[
                    "Opaque UV-Blocking Colors (Black, White, Custom Pantone)",
                    "Translucent Tints (Amber, Green, Blue)",
                    "Wrap-Around Tamper-Evident Shrink Sleeves",
                    "Custom Die-Cut Label Application",
                    "Direct Silk Screen Printing (On Glass Tubes)",
                    "Matte or Gloss Finished Caps"
                ]}
            />
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Discover a wide range of packaging options to complement your cannabis and wellness brand.
                        </p>
                    </div>
            ...
            <section className="py-8 bg-slate-50 border-t border-slate-100">
                <div className="container mx-auto px-[5vw]">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-tight">
                        Navigating Compliance with Custom Pre-Roll Packaging
                    </h2>
                    ...
                    <div className="h-[480px] overflow-y-auto border border-gray-200 bg-white rounded-lg shadow-sm p-8
                        ...
                        <div className="
                            ...
                            <p>
                                The cannabis industry is governed by complex and constantly evolving regulations, particularly regarding how products are packaged and presented to the consumer. Pre-rolls, being inherently fragile and highly aromatic, require packaging that serves multiple critical functions simultaneously: it must prevent the product from being crushed in a pocket, it must lock in pungent odors to allow for discreet transport, and, most importantly, it must be legally compliant.
                            </p>
                            <p>
                                At CustomPackMakers, we specialize in wholesale custom pre-roll tubes designed specifically for the cannabis industry. Our packaging solutions remove the guesswork from regulatory compliance, allowing your dispensary or cultivation brand to focus on design and market penetration.
                            </p>

                            <h3>Certified Child-Resistant (CR) Closures</h3>
                            <p>
                                In nearly every legal market, cannabis packaging must be certified child-resistant according to rigorous CPSC and ASTM standards. We offer two primary closure mechanisms that meet these strict requirements:
                            </p>
                            <ul>
                                <li><strong>The Pop-Top (Squeeze-to-Open):</strong> The industry standard for single pre-roll packaging. The consumer must apply simultaneous pressure to specific points below the cap to cause the hinged lid to "pop" open. It is cost-effective, easy for adults with dexterity issues to use, and highly secure against children.</li>
                                <li><strong>Push-and-Turn Screw Caps:</strong> Often used on premium glass tubes or multi-pack containers, these function similarly to traditional pharmaceutical pill bottles, providing an airtight, odor-proof seal.</li>
                            </ul>

                            <h3>Protecting Terpenes with Opaque Materials</h3>
                            <p>
                                Light, specifically UV radiation, is the enemy of cannabis. Exposure to light degrades cannabinoids (like THC) and evaporates the delicate terpenes that give your pre-rolls their unique flavor profiles and effects.
                            </p>
                            <ul>
                                <li><strong>Opaque PP Plastic:</strong> While clear tubes are popular for showing off the product, many states require cannabis packaging to be entirely opaque before leaving the dispensary. We manufacture our polypropylene (PP) tubes in solid black, white, and custom Pantone colors, completely blocking harmful light and ensuring compliance in strict jurisdictions.</li>
                                <li><strong>Airtight Seals:</strong> Both our pop-top and screw-cap tubes are engineered with precision-molded seals. This traps the humidity inside the tube, preventing the flower from drying out and ensuring a smooth, flavorful burn for the end-user.</li>
                            </ul>

                            <h3>Maximizing Brand Real Estate</h3>
                            <p>
                                A pre-roll tube is small, making branding a challenge. Furthermore, state laws dictate that extensive warning labels, lab results, and THC percentages must be clearly displayed on the packaging.
                            </p>
                            <ul>
                                <li><strong>Custom Label Application:</strong> We offer custom-designed, wrap-around pressure-sensitive labels that maximize the printable area of the tube. This provides ample space for your striking brand logo alongside all legally required compliance text.</li>
                                <li><strong>Tamper-Evident Shrink Sleeves:</strong> For an added layer of security and premium branding, we can provide full-body shrink sleeves that wrap over the cap. The consumer must tear a perforated line to open the tube, providing clear evidence that the product has not been tampered with since leaving the facility.</li>
                            </ul>
                            
                            <p>
                                Protect your product, ensure legal compliance, and elevate your cannabis brand with high-quality custom pre-roll tubes from CustomPackMakers.
                            </p>
                        </div>
                    </div>
                </div>
