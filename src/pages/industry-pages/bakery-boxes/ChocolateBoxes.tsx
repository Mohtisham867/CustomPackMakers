...
const ChocolateBoxes = () => {
  ...
  const imgs = [
    { src: productHero, alt: 'Chocolate Boxes Main' },
    { src: img2, alt: 'Chocolate Boxes View 2' },
    { src: img3, alt: 'Chocolate Boxes View 3' },
    { src: img4, alt: 'Chocolate Boxes View 4' },
    { src: img5, alt: 'Chocolate Boxes View 5' },
  ];
  return (
    <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
      <Helmet>
        <title>Custom Chocolate Boxes | Food-Grade Bakery Packaging | CustomPackMakers</title>
        <meta name="description" content="Custom chocolate boxes with FDA-approved grease-resistant food-safe materials. Wholesale bakery packaging with elegant finishes and fast 8-10 day turnaround." />
        <meta name="keywords" content="custom chocolate boxes, chocolate boxes packaging, food-safe chocolate boxes, wholesale chocolate boxes, bakery packaging" />
      </Helmet>
      <Header />
        ...
        <div className="container mx-auto px-[30px] py-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem><BreadcrumbPage>Chocolate Boxes</BreadcrumbPage></BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                <span className="text-primary">Custom</span> Chocolate Boxes
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                Premium FDA-approved chocolate boxes with grease-resistant food-safe materials, elegant finishes, and full-color custom printing. Wholesale pricing with 8-10 day turnaround for bakeries of every scale.
              </p>
            ...
            <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
              <img src={productHero} alt="Custom Chocolate Boxes" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            </div>
          </div>
        </div>
      </section>
      <section className="py-8 bg-slate-50">
        <div className="container mx-auto px-[5vw]">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">Chocolate Boxes Built for Food Safety, Freshness and Brand Impact</h2>
          <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
            <p>Our <strong className="text-foreground">custom chocolate boxes</strong> are engineered with FDA-approved food-grade SBS paperboard and grease-resistant coatings compliant with Title 21 food contact regulations. Every box protects your product's freshness, texture, and aroma from production to the customer's hands, while displaying your brand with full-color custom printing that makes a lasting impression on every recipient.</p>
            <p>With flexible sizing options, premium finishing including matte lamination, spot UV, foil stamping, and optional window panels, our wholesale chocolate boxes are designed to make your bakery brand stand out on every counter, shelf, and delivery. Our 8-10 business day turnaround and low minimum order quantities ensure accessible pricing at every scale of operation.</p>
          </div>
        </div>
      </section>
          ...
          <div className="h-[480px] overflow-y-auto border border-gray-200 bg-white rounded-lg shadow-sm p-8 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-primary [&::-webkit-scrollbar-thumb]:rounded-full">
            <div className="[&>h3]:text-xl [&>h3]:font-bold [&>h3]:text-slate-900 [&>h3]:mt-8 [&>h3]:mb-3 [&>h3]:first:mt-0 [&>p]:text-[15px] [&>p]:leading-relaxed [&>p]:text-slate-600 [&>p]:mb-5 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-5 [&>ul]:space-y-2 [&>ul>li]:text-[15px] [&>ul>li]:text-slate-600">
              ...
              <ul>
                ...
                <li><strong>Moisture Management Coatings:</strong> Clay-coated interior surfaces and optional PE vapor barriers regulate moisture transmission, keeping your chocolate boxes at the precise humidity level required to maintain optimal product texture and sensory quality during display and delivery.</li>
            ...
            <div className="space-y-5">
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">Our chocolate boxes use FDA Title 21 compliant SBS paperboard with grease-resistant and moisture barrier coatings. Every material is certified for direct food contact, protecting your customers and your business from food safety risks at every scale of operation.</p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">Reinforced base panels, precision-engineered closure systems, and CAD-modeled stacking load compliance protect your chocolate boxes through handling, transport, and retail display. Our field-tested structural designs eliminate the crushing and collapse failures that damage products and your brand reputation.</p>
                </div>
              </div>
              <div className="w-full h-px bg-slate-100" />
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">Full-color CMYK printing, spot UV logos, foil stamping, and soft-touch matte lamination transform your chocolate boxes into powerful brand marketing assets. Premium packaging communicates premium quality throughout the entire customer experience, driving loyalty, repeat purchases, and social sharing that grows your bakery business.</p>
                </div>
              </div>
            </div>
            <div className="relative flex items-center justify-center py-8">
              <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                <img src={productHero} alt="Premium Custom Chocolate Boxes Packaging" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative group">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                <img src={productHero} alt="Differentiate Your Chocolates Brand" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="space-y-6 lg:pl-10">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight">Differentiate Your <span className="text-primary">Chocolates</span> From Others</h2>
              <p className="text-base text-slate-600 leading-relaxed max-w-xl">CustomPackMakers brings together food safety engineering, structural protection science, and premium brand aesthetics to create chocolate boxes that protect your products and grow your brand at every touchpoint. Our FDA-approved materials, precision closures, and luxury finishes ensure your bakery packaging is as carefully crafted as the products inside every box.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="space-y-6">
              ...
              <Accordion type="single" collapsible defaultValue="faq-1" className="w-full space-y-2">
                {[
                  { id: 'faq-1', q: 'Are your chocolate boxes FDA approved?', a: 'Yes. All our chocolate boxes are manufactured using FDA Title 21 compliant food-grade SBS paperboard, water-based inks, and certified food-safe coatings. Every material is rigorously tested for direct and indirect food contact safety compliance.' },
            ...
            <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl overflow-hidden">
              <img src={FAQimage} alt="Chocolate Boxes FAQ" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
