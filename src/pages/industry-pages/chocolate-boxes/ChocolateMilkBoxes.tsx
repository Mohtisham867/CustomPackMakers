...
import chocolateMilkBoxesHero from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-hero.webp";
import chocolateMilkBoxesImg1 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-1.webp";
import chocolateMilkBoxesImg2 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-2.webp";
import chocolateMilkBoxesImg3 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-3.webp";
import chocolateMilkBoxesImg4 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-4.webp";
import chocolateMilkBoxesImg5 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-5.webp";
import chocolateMilkBoxesImg6 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-whychoose.webp";
import chocolateMilkBoxesImg7 from "@/assets/industry/chocolate-boxes/chocolate-milk-boxes/img-different.webp";
...
const ChocolateMilkBoxes = () => {
    ...
    const productImages = [
        { src: chocolateMilkBoxesImg1, alt: "Chocolate Milk Boxes - Main View" },
        { src: chocolateMilkBoxesImg2, alt: "Chocolate Milk Boxes - Side View" },
        { src: chocolateMilkBoxesImg3, alt: "Chocolate Milk Boxes - Detail" },
        { src: chocolateMilkBoxesImg4, alt: "Chocolate Milk Boxes - Opened" },
        { src: chocolateMilkBoxesImg5, alt: "Chocolate Milk Boxes - Lifestyle" },
    ];
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <img src={chocolateMilkBoxesHero} alt="Custom Chocolate Milk Boxes" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={chocolateMilkBoxesImg6} alt="Premium chocolate milk packaging" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={chocolateMilkBoxesImg7} alt="Differentiate Your Chocolate Milk Brand" className="w-full h-full object-cover" />
