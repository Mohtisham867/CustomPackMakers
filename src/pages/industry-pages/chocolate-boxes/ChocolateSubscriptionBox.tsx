...
import chocolateSubscriptionBoxHero from "@/assets/chocolate-products/chocolate-subscription-box/img-hero.png";
import chocolateSubscriptionBoxImg1 from "@/assets/chocolate-products/chocolate-subscription-box/img-1.png";
import chocolateSubscriptionBoxImg2 from "@/assets/chocolate-products/chocolate-subscription-box/img-2.png";
import chocolateSubscriptionBoxImg3 from "@/assets/chocolate-products/chocolate-subscription-box/img-3.png";
import chocolateSubscriptionBoxImg4 from "@/assets/chocolate-products/chocolate-subscription-box/img-4.png";
import chocolateSubscriptionBoxImg5 from "@/assets/chocolate-products/chocolate-subscription-box/img-5.png";
import chocolateSubscriptionBoxImg6 from "@/assets/chocolate-products/chocolate-subscription-box/img-whychoose.png";
import chocolateSubscriptionBoxImg7 from "@/assets/chocolate-products/chocolate-subscription-box/img-different.png";
...
const ChocolateSubscriptionBox = () => {
    ...
    const productImages = [
        { src: chocolateSubscriptionBoxImg1, alt: "Chocolate Subscription Box - Main View" },
        { src: chocolateSubscriptionBoxImg2, alt: "Chocolate Subscription Box - Monthly Theme" },
        { src: chocolateSubscriptionBoxImg3, alt: "Chocolate Subscription Box - Interior Reveal" },
        { src: chocolateSubscriptionBoxImg4, alt: "Chocolate Subscription Box - Personalized Card" },
        { src: chocolateSubscriptionBoxImg5, alt: "Chocolate Subscription Box - Lifestyle" },
    ];
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <img src={chocolateSubscriptionBoxHero} alt="Chocolate Subscription Box" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={chocolateSubscriptionBoxImg6} alt="Chocolate subscription box packaging" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={chocolateSubscriptionBoxImg7} alt="Differentiate Your Chocolate Subscription Brand" className="w-full h-full object-cover" />
