...
// Images
import disposableCoffeeCupsHero from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-hero.webp";
import disposableCoffeeCups1 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-1.webp";
import disposableCoffeeCups2 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-2.webp";
import disposableCoffeeCups3 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-3.webp";
import disposableCoffeeCups4 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-4.webp";
import disposableCoffeeCups5 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-5.webp";
import disposableCoffeeCups6 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-whychoose.webp";
import disposableCoffeeCups7 from "@/assets/industry/tea-coffee-cups/Disposable-Coffee-Cups/img-different.webp";
...
const DisposableCoffeeCups = () => {
    ...
    const productImages = [
        { src: disposableCoffeeCups1, alt: "Disposable Coffee Cups - Main View" },
        { src: disposableCoffeeCups2, alt: "Disposable Coffee Cups - Side Angle" },
        { src: disposableCoffeeCups3, alt: "Disposable Coffee Cups - Stacked View" },
        { src: disposableCoffeeCups4, alt: "Disposable Coffee Cups - Detail Shot" },
        { src: disposableCoffeeCups5, alt: "Disposable Coffee Cups - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Disposable Coffee Cups | Printed Drinkware | CustomPackMakers</title>
                <meta name="description" content="Order custom disposable coffee cups wholesale. Premium branded single-use cups with highly effective heat insulation, high-fidelity printing, and leak-proof seams." />
                <meta name="keywords" content="disposable coffee cups, custom printed disposable cups, branded takeaway cups, disposable cups wholesale" />
                <meta property="og:title" content="Custom Disposable Coffee Cups | Printed Drinkware | CustomPackMakers" />
                <meta property="og:description" content="Premium custom disposable coffee cups for brands. Superior heat insulation, vibrant full-color printing & dependable leak resistance. Get a quote today." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Disposable Coffee Cups</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Disposable</span> Coffee Cups
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Serve everyday convenience wrapped in unforgettable branding. Expertly manufactured disposable coffee cups utilizing incredibly strong structural bases, flawless seam integrity, and completely edge-to-edge vibrant customization options.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={disposableCoffeeCupsHero}
                                    alt="Disposable Coffee Cups Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Disposable Cups Built for High Volume, High Impact Serving
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom disposable coffee cups</strong> perfectly balance everyday utility with powerful brand storytelling. Built around premium, highly insulated paperboard frameworks specifically lined with protective PLA or PE barriers, they ensure impressive rigidity under extreme temperatures while completely preventing unexpected structural failure during active consumer transport.
                        </p>
                        <p>
                            Whether supporting a massive food festival or outfitting daily cafe operations, our <strong className="text-foreground">branded single-use cups</strong> deliver uncompromised consistency. Leveraging advanced wrap-around digital printing that faithfully reproduces complex logos and gradients flawlessly across curved surfaces, your essential daily serving vessels effortlessly transform into far-reaching mobile promotional assets your audience engages with daily.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            ...
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img
                                    src={disposableCoffeeCups6}
                                    alt="Premium Custom Disposable Coffee Cups"
                                    className="w-full h-full object-cover"
                                />
...
export default DisposableCoffeeCups;
