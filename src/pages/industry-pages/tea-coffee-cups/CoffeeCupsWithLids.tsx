...
// Images
import coffeeCupsWithLidsHero from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-hero.webp";
import coffeeCupsWithLids1 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-1.webp";
import coffeeCupsWithLids2 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-2.webp";
import coffeeCupsWithLids3 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-3.webp";
import coffeeCupsWithLids4 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-4.webp";
import coffeeCupsWithLids5 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-5.webp";
import coffeeCupsWithLids6 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-whychoose.webp";
import coffeeCupsWithLids7 from "@/assets/industry/tea-coffee-cups/coffee-cups-with-lids/img-different.webp";
...
const CoffeeCupsWithLids = () => {
    ...
    const productImages = [
        { src: coffeeCupsWithLids1, alt: "Coffee Cups with Lids - Main View" },
        { src: coffeeCupsWithLids2, alt: "Coffee Cups with Lids - Side Angle" },
        { src: coffeeCupsWithLids3, alt: "Coffee Cups with Lids - Lid Detail View" },
        { src: coffeeCupsWithLids4, alt: "Coffee Cups with Lids - Open View" },
        { src: coffeeCupsWithLids5, alt: "Coffee Cups with Lids - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Coffee Cups with Lids | Secure Fit Packaging | CustomPackMakers</title>
                <meta name="description" content="Order custom coffee cups with secure-fit lids wholesale. Premium branded cups with exceptional insulation, dynamic printing, and leak-proof sealing." />
                <meta name="keywords" content="coffee cups with lids, custom coffee cups, secure fit lids, disposable cups with lids wholesale" />
                <meta property="og:title" content="Custom Coffee Cups with Lids | Secure Fit Packaging | CustomPackMakers" />
                <meta property="og:description" content="Premium custom coffee cups with secure-fit lids. Exceptional heat insulation, high-resolution printing & spill-proof design. Get a quote today." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Coffee Cups With Lids</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Coffee Cups</span> With Lids
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Provide flawless service with our premium coffee cups with lids. Designed to securely snap tight, retain optimal heat, and boldly exhibit your vibrant brand colors for unmatched consumer confidence on the go.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={coffeeCupsWithLidsHero}
                                    alt="Coffee Cups With Lids Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Complete Coffee Cup and Lid Systems Built for Zero Spills and High Style
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">coffee cups with lids</strong> are meticulously engineered for drive-thrus, cafes, and rapid-service environments demanding absolute reliability. Constructed from ultra-durable paperboard tailored with precision-fitted sip lids, each combo eliminates frustrating leaks while establishing a sophisticated, cohesive brand image the moment your customer receives their order.
                        </p>
                        <p>
                            From hot flat whites to iced craft blends, our <strong className="text-foreground">custom branded cup sets</strong> adapt to every temperature curve. Featuring heavily reinforced, densely rolled rims, tightly locking closure mechanisms, and flawless exterior surfaces primed for spectacular custom CMYK branding, we equip your business to deliver a mess-free, visually stunning beverage experience every single time.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            ...
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img
                                    src={coffeeCupsWithLids6}
                                    alt="Premium Custom Coffee Cups With Lids"
                                    className="w-full h-full object-cover"
                                />
...
export default CoffeeCupsWithLids;
