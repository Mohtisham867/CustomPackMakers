...
// Images
import paperCoffeeCupsHero from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-hero.webp";
import paperCoffeeCups1 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-1.webp";
import paperCoffeeCups2 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-2.webp";
import paperCoffeeCups3 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-3.webp";
import paperCoffeeCups4 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-4.webp";
import paperCoffeeCups5 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-5.webp";
import paperCoffeeCups6 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-whychoose.webp";
import paperCoffeeCups7 from "@/assets/industry/tea-coffee-cups/paper-coffee-cups/img-different.webp";
...
const PaperCoffeeCups = () => {
    ...
    const productImages = [
        { src: paperCoffeeCups1, alt: "Paper Coffee Cups - Main View" },
        { src: paperCoffeeCups2, alt: "Paper Coffee Cups - Side Angle" },
        { src: paperCoffeeCups3, alt: "Paper Coffee Cups - Top View" },
        { src: paperCoffeeCups4, alt: "Paper Coffee Cups - Detail Shot" },
        { src: paperCoffeeCups5, alt: "Paper Coffee Cups - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Paper Coffee Cups | Sustainable Drinkware | CustomPackMakers</title>
                <meta name="description" content="Order custom paper coffee cups wholesale. Premium branded sustainable cups with reliable heat resistance, beautiful printed graphics, and eco-friendly composition." />
                <meta name="keywords" content="paper coffee cups, custom paper cups, branded paper coffee cups, sustainable coffee cups wholesale" />
                <meta property="og:title" content="Custom Paper Coffee Cups | Sustainable Drinkware | CustomPackMakers" />
                <meta property="og:description" content="Premium custom paper coffee cups. Reliable heat resistance, vibrant full-color printing & eco-friendly composition. Get a free quote." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Paper Coffee Cups</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Paper</span> Coffee Cups
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Enhance modern coffee service with high-quality custom paper cups. Combining essential structural reliability with vibrant wrap-around printing to powerfully reflect your brand's unique identity with every single serving.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={paperCoffeeCupsHero}
                                    alt="Paper Coffee Cups Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Paper Cups Built for Sustainable Style and Reliable Performance
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom paper coffee cups</strong> are precisely manufactured for modern brands demanding a cohesive blend of dependable utility and eye-catching aesthetics. Formed utilizing distinctly robust, high-grade paperboards lined thoughtfully for moisture resistance, they effectively maintain crucial drink temperatures while providing an undeniably premium, comforting tactile experience your customers immediately appreciate during their daily routine.
                        </p>
                        <p>
                            Covering standard drink profiles including 8oz, 12oz, and 16oz capacities, our <strong className="text-foreground">branded paper cups</strong> adapt seamlessly to your active service flow. Through integrating state-of-the-art flexographic and vibrant offset printing technologies, our production effortlessly wraps your detailed logos, typography, and intricate signature artwork fully around the exterior, completely redefining standard takeaway service into highly effective ambient advertising.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            ...
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img
                                    src={paperCoffeeCups6}
                                    alt="Premium Custom Paper Coffee Cups"
                                    className="w-full h-full object-cover"
                                />
...
export default PaperCoffeeCups;
