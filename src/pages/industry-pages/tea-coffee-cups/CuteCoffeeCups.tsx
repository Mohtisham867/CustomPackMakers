...
// Images
import heroImage from "@/assets/tea-coffee-cups/Cute Coffee Cups.png";
...
const CuteCoffeeCups = () => {
    ...
    const productImages = [
        { src: heroImage, alt: "Cute Coffee Cups - Main View" },
        { src: heroImage, alt: "Cute Coffee Cups - Side Angle" },
        { src: heroImage, alt: "Cute Coffee Cups - Group View" },
        { src: heroImage, alt: "Cute Coffee Cups - Detail Shot" },
        { src: heroImage, alt: "Cute Coffee Cups - Lifestyle Shot" },
    ];
