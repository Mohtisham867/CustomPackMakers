...
// Images
import customTeaBoxesHero from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-hero.webp";
import customTeaBoxes1 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-1.webp";
import customTeaBoxes2 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-2.webp";
import customTeaBoxes3 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-3.webp";
import customTeaBoxes4 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-4.webp";
import customTeaBoxes5 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-5.webp";
import customTeaBoxes6 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-whychoose.webp";
import customTeaBoxes7 from "@/assets/industry/tea-coffee-cups/custom-tea-boxes/img-different.webp";
...
const CustomTeaBoxes = () => {
    ...
    const productImages = [
        { src: customTeaBoxes1, alt: "Custom Tea Boxes - Main View" },
        { src: customTeaBoxes2, alt: "Custom Tea Boxes - Side Angle" },
        { src: customTeaBoxes3, alt: "Custom Tea Boxes - Open Box View" },
        { src: customTeaBoxes4, alt: "Custom Tea Boxes - Detail Shot" },
        { src: customTeaBoxes5, alt: "Custom Tea Boxes - Lifestyle Shot" },
    ];
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                ...
                <meta name="description" content="Order custom tea boxes wholesale. Premium branded tea packaging with internal flavor dividers, vibrant graphics, and full customization." />
                <meta name="keywords" content="custom tea packaging, custom tea boxes, wholesale tea boxes, custom branded tea packaging" />
                <meta property="og:title" content="Custom Tea Boxes | Premium Tea Packaging | CustomPackMakers" />
                <meta property="og:description" content="Premium custom tea packaging for tea brands. Quality construction, full-color printing & eco-friendly options. Get a free quote." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Custom Tea Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Elevate your brew with our custom tea boxes. Wholesale packaging designed to preserve freshness, showcase your branding elegantly, and deliver an unforgettable tea-drinking experience your customers will cherish.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={customTeaBoxesHero}
                                    alt="Custom Tea Boxes Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Tea Packaging Built for Brands That Value Flavor and Presentation
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom tea boxes</strong> are precision-engineered for brands that refuse to compromise on quality. Constructed from premium paperboard and specialty materials, each box delivers the structural strength your supply chain demands while projecting the brand identity your customers remember. Whether you're launching a luxury loose-leaf collection or scaling a wholesale operation, our <strong className="text-foreground">custom branded tea packaging</strong> is designed to perform at every touchpoint.
                        </p>
                        <p>
                            From herbal blends to premium matcha, our <strong className="text-foreground">custom packaging solutions</strong> accommodate every size, shape, and style. Each box features reinforced corners, precision-cut inserts, and optional display windows, ensuring your product arrives in showroom condition, every time. With full-color CMYK printing, foil stamping, embossing, and matte or gloss lamination, your <strong className="text-foreground">tea packaging</strong> becomes a powerful brand asset. Order wholesale with low minimums and our industry-leading turnaround.
                        </p>
                    </div>
                </div>
            </section>
