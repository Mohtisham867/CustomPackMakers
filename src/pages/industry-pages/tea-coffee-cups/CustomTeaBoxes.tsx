...
// Images
import heroImage from "@/assets/tea-coffee-cups/custom-tea-boxes.webp";
...
const CustomTeaBoxes = () => {
    ...
    const productImages = [
        { src: heroImage, alt: "Custom Tea Boxes - Main View" },
        { src: heroImage, alt: "Custom Tea Boxes - Side Angle" },
        { src: heroImage, alt: "Custom Tea Boxes - Open Box View" },
        { src: heroImage, alt: "Custom Tea Boxes - Detail Shot" },
        { src: heroImage, alt: "Custom Tea Boxes - Lifestyle Shot" },
    ];
