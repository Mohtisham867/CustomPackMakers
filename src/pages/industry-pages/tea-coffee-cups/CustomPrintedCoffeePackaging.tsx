...
// Images
import customPrintedCoffeeHero from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-hero.webp";
import customPrintedCoffee1 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-1.webp";
import customPrintedCoffee2 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-2.webp";
import customPrintedCoffee3 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-3.webp";
import customPrintedCoffee4 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-4.webp";
import customPrintedCoffee5 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-5.webp";
import customPrintedCoffee6 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-whychoose.webp";
import customPrintedCoffee7 from "@/assets/industry/tea-coffee-cups/custom-printed-coffee-packaging/img-different.webp";
...
const CustomPrintedCoffeePackaging = () => {
    ...
    // Using the same hero image for the gallery as placeholders
    const productImages = [
        { src: customPrintedCoffee1, alt: "Custom Printed Coffee Packaging - Main View" },
        { src: customPrintedCoffee2, alt: "Custom Printed Coffee Packaging - Side Angle" },
        { src: customPrintedCoffee3, alt: "Custom Printed Coffee Packaging - Open Box View" },
        { src: customPrintedCoffee4, alt: "Custom Printed Coffee Packaging - Detail Shot" },
        { src: customPrintedCoffee5, alt: "Custom Printed Coffee Packaging - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Printed Coffee Packaging | Wholesale Bags | CustomPackMakers</title>
                <meta name="description" content="Order custom printed coffee packaging wholesale. Premium branded coffee bags with freshness valves, vibrant wraps, and eco-friendly compostable choices." />
                <meta name="keywords" content="custom coffee bags, printed coffee packaging, custom coffee packaging wholesale, custom printed coffee packaging" />
                <meta property="og:title" content="Custom Printed Coffee Packaging | Wholesale Bags | CustomPackMakers" />
                <meta property="og:description" content="Premium custom coffee packaging for coffee roasters. Freshness valves, full-color printing & eco-friendly options. Get a free quote." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Custom Printed Coffee Packaging</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Custom Printed</span> Coffee Packaging
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Command shelf presence with our custom printed coffee packaging. Designed to preserve roasted flavor perfectly while turning every poured cup into an immersive, premium branded beverage experience.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={customPrintedCoffeeHero}
                                    alt="Custom Printed Coffee Packaging Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Coffee Packaging Built for Roasters That Mean Business
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom coffee packaging</strong> solutions are precision-engineered for roasters and cafes that refuse to compromise on bean freshness. Constructed with specialized high-barrier films and degassing valves, each bag delivers the crucial preservation your quality product demands while projecting the identity your customers love.
                        </p>
                        <p>
                            From whole bean espresso roasts to single-origin grounds, our <strong className="text-foreground">custom branded coffee packaging</strong> accommodates every weight, style, and retail environment. Each package features reinforced side gussets, secure zipper seals, and an optional flat bottom for upright display, ensuring your product stands out perfectly.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="h-[480px] overflow-y-auto border border-gray-200 bg-white rounded-lg shadow-sm p-8
                        ...
                        <div className="
                            ...
                            <ul>
                                ...
                                <li><strong>High-Barrier Liners:</strong> For maximum freshness retention, specialized liners ensure your coffee and coffee products remain perfectly preserved from roaster to cup.</li>
                            </ul>
                            <p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex gap-6 items-start group">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 leading-relaxed">
                                        Our double-wall insulation technology provides superior heat retention while ensuring external comfort holding hot beverages, eliminating the need for separate sleeves and elevating the overall premium feel of every served drink.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6 items-start group">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 leading-relaxed">
                                        We utilize state-of-the-art high-definition wrap-around printing techniques to seamlessly apply vibrant, precisely matched brand colors across your items, creating stunning visual consistency that instantly attracts attention across all physical retail environments.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6 items-start group">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 leading-relaxed">
                                        Our commitment to sustainability shines through our eco-friendly compostable materials, featuring highly reliable secure-fit lids. Empower your brand by offering completely biodegradable packaging that meets modern consumer expectations without sacrificing quality performance.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            ...
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img
                                    src={customPrintedCoffee6}
                                    alt="Premium Custom Tea Box Packaging"
                                    className="w-full h-full object-cover"
                                />
...
export default CustomPrintedCoffeePackaging;
