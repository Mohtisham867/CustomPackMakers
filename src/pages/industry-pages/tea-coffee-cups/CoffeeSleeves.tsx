...
// Images
import coffeeSleevesHero from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-hero.webp";
import coffeeSleeves1 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-1.webp";
import coffeeSleeves2 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-2.webp";
import coffeeSleeves3 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-3.webp";
import coffeeSleeves4 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-4.webp";
import coffeeSleeves5 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-5.webp";
import coffeeSleeves6 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-whychoose.webp";
import coffeeSleeves7 from "@/assets/industry/tea-coffee-cups/coffee-sleeves/img-different.webp";
...
const CoffeeSleeves = () => {
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Coffee Sleeves | Branded Cup Jackets | CustomPackMakers</title>
                <meta name="description" content="Order custom coffee sleeves wholesale. Premium branded cup jackets with corrugated heat protection, dynamic wrap-around prints, and complete customization." />
                <meta name="keywords" content="custom coffee sleeves, branded coffee sleeves, disposable coffee sleeves, paper coffee sleeves wholesale" />
                <meta property="og:title" content="Custom Coffee Sleeves | Branded Cup Jackets | CustomPackMakers" />
                <meta property="og:description" content="Premium custom coffee sleeves for cafes. Superior heat insulation, full-color printing & eco-friendly options. Get a free quote." />
            </Helmet>
            <Header />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Enhance every hot pour with custom printed coffee sleeves. Expertly crafted to provide essential thermal protection while transforming standard takeaway cups into highly visible, walking advertisements for your brand's unique identity.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Coffee Sleeves Built for Safety, Grip, and Striking Promotion
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom coffee sleeves</strong> are engineered for cafes and restaurants that demand both utility and memorable branding. Constructed with high-grade corrugated paperboards, each sleeve efficiently insulates extreme heat while delivering an incredibly satisfying tactile grip, ensuring your customers safely carry their drinks without compromising on the premium experience.
                        </p>
                        <p>
                            Compatible with all standard 8oz, 12oz, 16oz, and 20oz paper cups, our <strong className="text-foreground">custom branded cup sleeves</strong> perfectly mold to tapered containers. Featuring edge-to-edge high-definition CMYK pigment printing, specialized embossing, and sustainable recycled kraft material choices, every individual serving instantly becomes a dynamic, personalized marketing opportunity spanning across your local community footprint.
                        </p>
                    </div>
                </div>
            </section>
