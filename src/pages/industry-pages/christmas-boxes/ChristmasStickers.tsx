...
import christmasStickersHero from "@/assets/industry/christmas-boxes/christmas-stickers/img-hero.webp";
import christmasStickersImg1 from "@/assets/industry/christmas-boxes/christmas-stickers/img-1.webp";
import christmasStickersImg2 from "@/assets/industry/christmas-boxes/christmas-stickers/img-2.webp";
import christmasStickersImg3 from "@/assets/industry/christmas-boxes/christmas-stickers/img-3.webp";
import christmasStickersImg4 from "@/assets/industry/christmas-boxes/christmas-stickers/img-4.webp";
import christmasStickersImg5 from "@/assets/industry/christmas-boxes/christmas-stickers/img-5.webp";
import christmasStickersImg6 from "@/assets/industry/christmas-boxes/christmas-stickers/img-whychoose.webp";
import christmasStickersImg7 from "@/assets/industry/christmas-boxes/christmas-stickers/img-different.webp";
...
const ChristmasStickers = () => {
    ...
    const productImages = [
        { src: christmasStickersImg1, alt: "Christmas Stickers - Main View" },
        { src: christmasStickersImg2, alt: "Christmas Stickers - Holographic Silver" },
        { src: christmasStickersImg3, alt: "Christmas Stickers - Contour Cut" },
        { src: christmasStickersImg4, alt: "Christmas Stickers - Kraft Paper" },
        { src: christmasStickersImg5, alt: "Christmas Stickers - Sheet Format" },
    ];
    useEffect(() => {
        if (!api) return;
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <img src={christmasStickersHero} alt="Christmas Stickers" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={christmasStickersImg6} alt="Christmas stickers" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={christmasStickersImg7} alt="Differentiate Your Christmas Stickers" className="w-full h-full object-cover" />
                            </div>
                        </div>
