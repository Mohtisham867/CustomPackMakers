...
import christmasPaperBagsHero from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-hero.webp";
import christmasPaperBagsImg1 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-1.webp";
import christmasPaperBagsImg2 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-2.webp";
import christmasPaperBagsImg3 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-3.webp";
import christmasPaperBagsImg4 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-4.webp";
import christmasPaperBagsImg5 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-5.webp";
import christmasPaperBagsImg6 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-whychoose.webp";
import christmasPaperBagsImg7 from "@/assets/industry/christmas-boxes/christmas-paper-bags/img-different.webp";
...
const ChristmasPaperBags = () => {
    ...
    const productImages = [
        { src: christmasPaperBagsImg1, alt: "Christmas Paper Bags - Main View" },
        { src: christmasPaperBagsImg2, alt: "Christmas Paper Bags - Rope Handle" },
        { src: christmasPaperBagsImg3, alt: "Christmas Paper Bags - Ribbon Handle" },
        { src: christmasPaperBagsImg4, alt: "Christmas Paper Bags - Kraft Eco" },
        { src: christmasPaperBagsImg5, alt: "Christmas Paper Bags - Large Retail" },
    ];
    useEffect(() => {
        if (!api) return;
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <img src={christmasPaperBagsHero} alt="Christmas Paper Bags" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={christmasPaperBagsImg6} alt="Christmas paper bags" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={christmasPaperBagsImg7} alt="Differentiate Your Christmas Paper Bags" className="w-full h-full object-cover" />
                            </div>
                        </div>
