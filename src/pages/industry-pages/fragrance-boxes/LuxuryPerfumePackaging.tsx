...
const LuxuryPerfumePackaging = () => {
    ...
    const productImages = [
        { src: luxuryPerfumePackaging, alt: "Luxury Perfume Packaging - Main View" },
        { src: heroImage, alt: "High-End Perfume Display" },
        { src: customPerfumeBoxes, alt: "Premium Rigid Perfume Box Structure" },
        { src: perfumeSubscriptionBoxes, alt: "Artisan Fragrance Presentation" },
        { src: incenseBoxes, alt: "Luxury Scent Brand Packaging" },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={luxuryPerfumePackaging} alt="Differentiate Your Luxury Perfume Brand" className="w-full h-full object-cover" />
