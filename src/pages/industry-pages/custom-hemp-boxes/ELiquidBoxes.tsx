...
const ELiquidBoxes = () => {
    ...
    const productImages = [
        { src: eliquidboxeimg1, alt: "Custom Hemp E-Liquid Boxes Main" },
        { src: eliquidboxeimg2, alt: "Vape Juice Bottle Packaging" },
        { src: eliquidboxeimg3, alt: "Sustainable E-Juice Cartons" },
        { src: eliquidboxeimg4, alt: "Eco-Friendly Premium CBD Vape Boxes" },
        { src: eliquidboxeimg5, alt: "Premium Extra View" },
    ];
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <img src={eliquidboxehero} alt="Custom Hemp E-Liquid Boxes" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={eliquidboxeimg6} alt="Sustainable Hemp E-Liquid Box Quality" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={eliquidboxeimg7} alt="Differentiate Your Eco-Friendly Brand" className="w-full h-full object-cover" />
                            </div>
                        </div>
