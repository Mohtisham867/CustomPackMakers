...
import productHero from "@/assets/cannabis-packaging/seed-packaging.png";
...
const CannabisSeedPackaging = () => {
    ...
    const productImages = [
        { src: productHero, alt: "Custom Cannabis Seed Packaging" },
        { src: productHero, alt: "Seed Packet Box Design" },
        { src: productHero, alt: "Cannabis Seed Container Open" },
        { src: productHero, alt: "Moisture-Proof Seed Packaging" },
        { src: productHero, alt: "Branded Cannabis Seed Box" },
    ];
    useEffect(() => {
        if (!api) return;
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img src={productHero} alt="Custom Cannabis Seed Packaging" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                        ...
                        <div className="relative flex items-center justify-center py-8">
                            <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '1/1' }}>
                                <img src={productHero} alt="Professional cannabis seed packaging" className="w-full h-full object-cover" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative group">
                            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl transform transition-transform duration-700 hover:scale-[1.02]">
                                <img src={productHero} alt="Differentiate Your Seed Brand" className="w-full h-full object-cover" />
