...
const CreditCardBoxesMaterial = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    const productImages = [
        { src: creditCardBoxes, alt: "Custom Credit Card Boxes - Main View" },
        { src: placeholder1, alt: "Custom Credit Card Boxes - Angle" },
        { src: placeholder2, alt: "Custom Credit Card Boxes - Detail" },
        { src: placeholder3, alt: "Custom Credit Card Boxes - Close up" },
        { src: placeholder4, alt: "Custom Credit Card Boxes - Lifestyle" },
    ];
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                ...
                <meta name="keywords" content="custom credit card boxes, luxury credit card boxes, wholesale rigid boxes, custom branded packaging, rigid box manufacturer" />
                <meta property="og:title" content="Custom Credit Card Boxes | Premium Rigid Packaging | CustomPackMakers" />
                <meta property="og:description" content="Premium custom credit card boxes for luxury brands. Rigid boxes, magnetic closures, full-color printing & eco-friendly options. Get a free quote." />
            </Helmet>
            <Header />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Wholesale custom branded credit card boxes engineered for luxury presentation, extreme durability, and a premium unboxing experience built to scale with your business.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Custom Credit Card Boxes Built for Luxury Brands That Mean Business
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">custom credit card boxes</strong> are precision-engineered for B2B brands that refuse to compromise on quality. Constructed from high-end rigid chipboard, premium specialty stocks, and elegant textured materials, each box delivers the sophisticated presentation your luxury items demand while projecting the brand identity your customers remember. Whether you're launching a designer line or scaling a boutique, our <strong className="text-foreground">custom branded packaging</strong> is designed to perform at every touchpoint.
                        </p>
                        <p>
                            From minimalist styles to classic configurations, our <strong className="text-foreground">rigid credit card boxes</strong> solutions accommodate every size, silhouette, and style. Each box features pristine structural integrity, custom-cut velvet or foam inserts, and optional magnetic closures, ensuring your product is displayed magnificently. With foil stamping, embossing, and soft-touch lamination, your <strong className="text-foreground">luxury boxes</strong> become a powerful brand asset. Order wholesale with low minimums and our industry-leading 8–10 day turnaround.
                        </p>
                    </div>
                </div>
            </section>
...
export default CreditCardBoxesMaterial;
