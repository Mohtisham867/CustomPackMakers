...
import heroImage from "@/assets/shape-style/shipping-boxes/hemp-shipping-boxes.webp";
...
const HempShippingBoxes = () => {
    ...
    const productImages = [
        { src: heroImage, alt: "Hemp Shipping Boxes - Main View" },
        { src: heroImage, alt: "Hemp Shipping Boxes - Side Angle" },
        { src: heroImage, alt: "Hemp Shipping Boxes - Open Box View" },
        { src: heroImage, alt: "Hemp Shipping Boxes - Detail Shot" },
        { src: heroImage, alt: "Hemp Shipping Boxes - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Hemp Shipping Boxes | Custom Eco Packaging | CustomPackMakers</title>
                <meta name="description" content="Order custom hemp shipping boxes wholesale. Sustainable, premium packaging engineered for maximum durability, safe transit, and heavy-duty logistics." />
                <meta name="keywords" content="hemp shipping boxes, eco-friendly shipping packaging, heavy-duty shipping boxes, sustainable packaging" />
                <meta property="og:title" content="Hemp Shipping Boxes | Custom Eco Packaging" />
                <meta property="og:description" content="Sustainable custom shipping packaging engineered for durability and safe transit. Built with eco-friendly heavy-duty corrugated material." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Hemp Shipping Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Hemp</span> Shipping Boxes
                            </h1>
