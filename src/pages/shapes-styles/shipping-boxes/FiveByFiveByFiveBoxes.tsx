...
import heroImage from "@/assets/shape-style/shipping-boxes/5x5x5-boxes.webp";

// FAQ image
import FAQimage from "@/assets/FAQ-image.webp";

const FiveByFiveByFiveBoxes = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    // Product images for gallery
    const productImages = [
        { src: heroImage, alt: "5x5x5 Boxes - Main View" },
        { src: heroImage, alt: "5x5x5 Boxes - Side Angle" },
        { src: heroImage, alt: "5x5x5 Boxes - Open Box View" },
        { src: heroImage, alt: "5x5x5 Boxes - Detail Shot" },
        { src: heroImage, alt: "5x5x5 Boxes - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>5x5x5 Boxes | Custom Cube Mailers | CustomPackMakers</title>
                <meta name="description" content="Order 5x5x5 shipping boxes wholesale. Compact custom packaging engineered for maximum durability, safe transit, and heavy-duty small parcel logistics." />
                <meta name="keywords" content="5x5x5 boxes, cube shipping boxes, custom small mailers, secure cube packaging" />
                <meta property="og:title" content="5x5x5 Boxes | Custom Cube Mailers" />
                <meta property="og:description" content="Protective custom cube shipping packaging engineered for durability and safe transit. Built with heavy-duty corrugated material." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>5x5x5 Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">5x5x5</span> Boxes
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Wholesale custom cube shipping boxes engineered for maximum durability, completely safe transit, and premium unboxing experiences constructed completely from heavy-duty corrugated material.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">5x5x5 Boxes</strong> are precision-engineered to prioritize ultimate durability and guarantee safe transit for compact and cube-shaped items. Constructed strictly from heavy-duty corrugated material and premium kraft stocks, each rigid cube delivers robust structural strength to shield your merchandise against the harshest elements of modern logistics. Designed for brands that value uncompromised reliability, these custom boxes prevent crushing and external damage under continuous pressure during shipping. The perfect cubic dimensions maintain structural integrity exceptionally well, making them ideal for handling delicate cosmetics, small electronics, or specialized retail goods. Our shipping solutions are built to preserve product integrity scaling with the demands of any fast-paced fulfillment line while remaining lightweight and cost-effective for mass distribution.
                        </p>
                    </div>
                </div>
            </section>
...
export default FiveByFiveByFiveBoxes;
