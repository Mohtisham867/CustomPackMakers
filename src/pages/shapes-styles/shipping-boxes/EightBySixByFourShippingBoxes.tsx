...
import heroImage from "@/assets/shape-style/shipping-boxes/8x6x4-shipping-boxes.webp";

// FAQ image
import FAQimage from "@/assets/FAQ-image.webp";

const EightBySixByFourShippingBoxes = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    // Product images for gallery
    const productImages = [
        { src: heroImage, alt: "8x6x4 Shipping Boxes - Main View" },
        { src: heroImage, alt: "8x6x4 Shipping Boxes - Side Angle" },
        { src: heroImage, alt: "8x6x4 Shipping Boxes - Open Box View" },
        { src: heroImage, alt: "8x6x4 Shipping Boxes - Detail Shot" },
        { src: heroImage, alt: "8x6x4 Shipping Boxes - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>8x6x4 Shipping Boxes | Custom Mailers | CustomPackMakers</title>
                <meta name="description" content="Order 8x6x4 shipping boxes wholesale. Premium custom packaging engineered for maximum durability, safe transit, and heavy-duty small parcel logistics." />
                <meta name="keywords" content="8x6x4 shipping boxes, small shipping boxes, custom small mailers, secure packaging" />
                <meta property="og:title" content="8x6x4 Shipping Boxes | Custom Small Mailers" />
                <meta property="og:description" content="Protective custom shipping packaging engineered for durability and safe transit. Built with heavy-duty corrugated material for small parcels." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>8x6x4 Shipping Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">8x6x4</span> Shipping Boxes
                            </h1>
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">8x6x4 Shipping Boxes</strong> are precision-engineered to prioritize ultimate durability and guarantee safe transit for compact items. Constructed strictly from heavy-duty corrugated material and premium kraft stocks, each box delivers robust structural strength to shield your merchandise against the harshest elements of modern logistics. Designed for brands that value uncompromised reliability, these custom boxes prevent crushing and external damage under continuous pressure during shipping. Whether handling fragile electronics, cosmetics, or retail goods, our shipping solutions are built to preserve product integrity scaling with the demands of any fast-paced fulfillment line while optimizing dimensional shipping weight.
                        </p>
                    </div>
                </div>
            </section>
...
export default EightBySixByFourShippingBoxes;
