...
import heroImage from "@/assets/shape-style/shipping-boxes/white-shipping-boxes.webp";

// FAQ image
import FAQimage from "@/assets/FAQ-image.webp";

const WhiteShippingBoxes = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    // Product images for gallery
    const productImages = [
        { src: heroImage, alt: "White Shipping Boxes - Main View" },
        { src: heroImage, alt: "White Shipping Boxes - Side Angle" },
        { src: heroImage, alt: "White Shipping Boxes - Open Box View" },
        { src: heroImage, alt: "White Shipping Boxes - Detail Shot" },
        { src: heroImage, alt: "White Shipping Boxes - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>White Shipping Boxes | Custom Printed Mailers | CustomPackMakers</title>
                <meta name="description" content="Order pristine white shipping boxes wholesale. Protective custom packaging engineered for maximum durability, safe transit, and premium heavy-duty brand logistics." />
                <meta name="keywords" content="white shipping boxes, custom white mailers, premium shipping boxes, secure heavy duty packaging" />
                <meta property="og:title" content="White Shipping Boxes | Premium Corrugated Mailers" />
                <meta property="og:description" content="Pristine, rigid custom shipping packaging engineered for durability and safe transit. Built with premium white heavy-duty corrugated material." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>White Shipping Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">White</span> Shipping Boxes
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Wholesale custom shipping boxes engineered for maximum durability, completely safe transit, and pristine premium unboxing experiences constructed from heavy-duty white corrugated material.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Pristine Heavy-Duty Shipping Packaging Built for Safe Brand Transit
                    </h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">White Shipping Boxes</strong> are precision-engineered to prioritize ultimate durability and guarantee safe transit while delivering a visually premium presentation. Constructed strictly from heavy-duty corrugated material featuring a pristine white exterior liner, each box delivers robust structural strength to shield your merchandise against the harshest elements of modern logistics. Designed for brands that value uncompromised aesthetic reliability alongside physical defense, these custom boxes prevent crushing and external damage under continuous pressure during shipping. The brilliant white surface offers superior print contrast, making your custom branding pop brilliantly. Whether distributing luxury commerce or subscription kits, our shipping solutions are built to preserve both product integrity and brand image scaling with the demands of any fast-paced fulfillment line.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-[5vw]">
                    ...
                    <div className="h-[480px] overflow-y-auto border border-gray-200 bg-white rounded-lg shadow-sm p-8
                        ...
                        <div className="
                            ...
                            <p>
                                Our comprehensive array of custom shipping boxes addresses this critical requirement head-on. We focus intensely on designing robust structures that guarantee extreme durability and entirely safe transit. Every structural feature, from high-flute corrugated walls to impact-resistant corner reinforcements, is precisely calibrated to deflect shock, resist moisture, and handle tremendous compressive forces without failing. A premium white outer shell ensures that your products survive the most turbulent logistical journeys and arrive mirroring the precise condition they left your warehouse, looking pristine.
                            </p>
                            ...
                            <ul>
                                ...
                                <li><strong>Premium White Liners:</strong> We utilize top-grade white kraft paper specifically processed for tear strength and visual brilliance. This pristine exterior layer provides a striking canvas for branding while retaining the inherent strength of industrial logistics.</li>
                            ...
                            <ul>
                                <li><strong>High-Resolution Digital & Flexographic Printing:</strong> Print directly onto our smooth white corrugated outer layers with sharp details and bold, vibrant colors. Prominently display your logo, handling instructions, and marketing slogans so your package clearly identifies itself at every touchpoint.</li>
                            ...
                            <div className="flex gap-6 items-start group">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 leading-relaxed">
                                        Every shipping white box we produce is built from premium heavy-duty corrugated material. Our rigorous QC process ensures each unit meets the maximum durability standards required for flawless and safe transit across global shipping networks.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <Accordion type="single" collapsible defaultValue="item-1" className="w-full space-y-2">
                                {[
                                    ...
                                    {
                                        id: "item-2",
                                        question: "What makes the white boxes different from standard kraft?",
                                        answer: "Our white shipping boxes utilize a bleached kraft or mottled white paperboard liner over the heavy-duty corrugated core. This provides identical robust protection to standard kraft but offers a pristine, high-contrast surface ideal for premium branding and colored prints."
                                    },
                                    {
                                        id: "item-3",
                                    ...
                                    {
                                        id: "item-4",
                                        question: "Are they eco-friendly despite their durability and color?",
                                    ...
                                    },
                                    {
                                        ...
                                        answer: "Certainly. Our white shipping boxes are perfectly suited for advanced flexographic and digital printing to cleanly display your logos, handling directions, and brand colors brightly onto the sturdy exterior corrugated layers without undermining structure."
                                    }
                                ].map((faq) => (
                                    <AccordionItem
                                        key={faq.id}
...
export default WhiteShippingBoxes;
