...
import heroImage from "@/assets/shape-style/shipping-boxes/long-narrow-shipping-boxes.webp";

// FAQ image
import FAQimage from "@/assets/FAQ-image.webp";

const LongNarrowShippingBoxes = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    // Product images for gallery
    const productImages = [
        { src: heroImage, alt: "Long Narrow Shipping Boxes - Main View" },
        { src: heroImage, alt: "Long Narrow Shipping Boxes - Side Angle" },
        { src: heroImage, alt: "Long Narrow Shipping Boxes - Open Box View" },
        { src: heroImage, alt: "Long Narrow Shipping Boxes - Detail Shot" },
        { src: heroImage, alt: "Long Narrow Shipping Boxes - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Long Narrow Shipping Boxes | Custom Mailers | CustomPackMakers</title>
                <meta name="description" content="Order long narrow shipping boxes wholesale. Protective custom packaging engineered for maximum durability, safe transit, and heavy-duty corrugated logistics." />
                <meta name="keywords" content="long narrow shipping boxes, poster shipping boxes, custom corrugated mailers, secure packaging" />
                <meta property="og:title" content="Long Narrow Shipping Boxes | Custom Corrugated Mailers" />
                <meta property="og:description" content="Protective custom shipping packaging engineered for durability and safe transit. Built with heavy-duty corrugated material for long items." />
            </Helmet>
            <Header />
                ...
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Long Narrow Shipping Boxes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Long Narrow</span> Shipping Boxes
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Wholesale custom shipping boxes engineered for maximum durability, safe elongated product transit, and premium unboxing experiences constructed completely from heavy-duty corrugated material.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={heroImage}
                                    alt="Long Narrow Shipping Boxes Hero"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>
                            Our <strong className="text-foreground">Long Narrow Shipping Boxes</strong> are precision-engineered to prioritize ultimate durability and guarantee safe transit for awkward, elongated items. Constructed strictly from heavy-duty corrugated material and premium kraft stocks, each box delivers robust structural strength across its entire length to shield your merchandise against bending or snapping during modern logistics. Designed for brands that value uncompromised reliability, these custom boxes prevent crushing and external damage under continuous pressure. Whether shipping posters, rolled canvases, sporting equipment, or industrial parts, our unique elongated shipping solutions are built to preserve product integrity scaling with the demands of any fast-paced fulfillment line while easily stacking and optimizing space.
                        </p>
                    </div>
                </div>
            </section>
                                    ...
                                    <form className="space-y-4">
                                        <div className="grid grid-cols-3 gap-3">
                                            <div className="space-y-1.5">
                                                ...
                                                <Input id="length" type="number" placeholder="24" className="h-9 bg-white" />
                                            </div>
                                            <div className="space-y-1.5">
...
export default LongNarrowShippingBoxes;
