...
const DoubleWallTuckFront = () => {
    ...
    const productImages = [
        { src: heroImage, alt: "Double Wall Tuck Front - Main View" },
        { src: heroImage, alt: "Double Wall Tuck Front - Side Angle" },
        { src: heroImage, alt: "Double Wall Tuck Front - Open Box View" },
        { src: heroImage, alt: "Double Wall Tuck Front - Detail Shot" },
        { src: heroImage, alt: "Double Wall Tuck Front - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Double Wall Tuck Front Boxes | Custom Shipping Packaging</title>
                <meta name="description" content="Order double wall tuck front shipping boxes wholesale. Premium custom packaging engineered for maximum durability, safe transit, and heavy-duty logistics." />
                <meta name="keywords" content="double wall tuck front, custom shipping packaging, heavy-duty shipping boxes, corrugated mailers" />
                <meta property="og:title" content="Double Wall Tuck Front Boxes | Custom Shipping Packaging" />
                <meta property="og:description" content="Premium custom shipping packaging engineered for durability and safe transit. Built with heavy-duty corrugated material for superior strength." />
            </Helmet>
            <Header />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img
                                    src={heroImage}
                                    alt="Double Wall Tuck Front Hero"
