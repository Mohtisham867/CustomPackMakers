...
import fallbackHero from "@/assets/shape-style/custom-bags/kraft-bags.webp";
import FAQimage from "@/assets/FAQ-image.webp";

const KraftBags = () => {
    const [selectedImage, setSelectedImage] = useState(0);
    const productImages = [
        { src: fallbackHero, alt: "Kraft Bags - Main View" },
        { src: fallbackHero, alt: "Kraft Bags - Side Angle" },
        { src: fallbackHero, alt: "Kraft Bags - Open Bag View" },
        { src: fallbackHero, alt: "Kraft Bags - Detail Shot" },
        { src: fallbackHero, alt: "Kraft Bags - Lifestyle Shot" },
    ];
    const faqs = [
        { id: "item-1", question: "What Are The Benefits Of Custom Kraft Bags?", answer: "Our custom kraft bags deliver an authentic, eco-conscious brand image through natural brown paper textures that consumers associate with artisan quality. They are biodegradable, recyclable, printable with custom artwork, and provide excellent structural strength for retail goods, food service, and gift packaging." },
        ...
        { id: "item-3", question: "Are Fully Custom Dimensional Sizes Available?", answer: "Yes, we manufacture completely bespoke custom dimensional kraft bag structures from small boutique retail bags to large wholesale bulk bags, accommodating all your size requirements." },
        { id: "item-4", question: "What Gsm Options Are Available For Kraft Bags?", answer: "We offer a range of kraft paper weights from 70gsm for lightweight retail purposes to 150gsm+ for heavy-duty commercial applications including grocery, food service, and industrial packaging needs." },
        { id: "item-5", question: "Are These Bags Suitable For Food Products?", answer: "Yes, our kraft bags are available with food-safe coatings and liners that maintain their natural aesthetic while providing the necessary grease resistance and moisture protection required for food products including baked goods, snacks, and specialty foods." }
    ];
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Custom Kraft Bags | Premium Customized Packaging</title>
                <meta name="description" content="Order custom kraft bags with natural brown paper textures, eco-conscious branding, and premium printing. Wholesale pricing, fast turnaround." />
            </Helmet>
            <Header />
            <div className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 mt-[120px] md:mt-[160px]">
                <div className="container mx-auto px-[30px] py-4">
                    <Breadcrumb><BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem><BreadcrumbPage>Kraft Bags</BreadcrumbPage></BreadcrumbItem>
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight"><span className="text-primary">Custom</span> Kraft Bags</h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">Wholesale custom kraft bags with natural brown paper textures, eco-conscious branding, and premium printing built for artisan, food service, and sustainable retail brands.</p>
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200"><img src={fallbackHero} alt="Custom Kraft Bags Hero" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" /></div>
                        </div>
                    </div>
                </div>
            </section>
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">What Makes Our Kraft Bags Stand Out</h2>
                    <div className="text-muted-foreground leading-relaxed text-[15px] space-y-4 max-w-5xl">
                        <p>Our <strong className="text-foreground">custom kraft bags</strong> are precision-engineered for brands that value authentic, eco-conscious packaging. The natural brown paper texture immediately communicates artisan craftsmanship, sustainability, and premium quality — resonating deeply with today's environmentally conscious consumers across food service, retail, and gift packaging applications.</p>
                        <p>With custom printing, premium finishes, food-safe coating options, and a range of paper weights from 70gsm to 150gsm+, our kraft bags deliver the perfect combination of natural aesthetics and functional performance. Order wholesale with competitive pricing and our industry-leading 8–10 day turnaround.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-8 bg-slate-50 border-t border-slate-100">
                <div className="container mx-auto px-[5vw]">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-tight">The Ultimate Guide to Premium Kraft Bags</h2>
                    <div className="h-[480px] overflow-y-auto border border-gray-200 bg-white rounded-lg shadow-sm p-8 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-primary [&::-webkit-scrollbar-thumb]:rounded-full">
                        <div className="[&>h3]:text-xl [&>h3]:font-bold [&>h3]:text-slate-900 [&>h3]:mt-8 [&>h3]:mb-3 [&>h3]:first:mt-0 [&>p]:text-[15px] [&>p]:leading-relaxed [&>p]:text-slate-600 [&>p]:mb-5">
                            <p><strong>Kraft Bags</strong> represent the gold standard in eco-conscious, artisan packaging. The natural brown paper texture communicates authenticity and sustainable values that resonate deeply with today's consumers. Our meticulously crafted kraft bags are designed for artisan food brands, retail boutiques, and any business that wants to communicate environmental responsibility alongside premium product quality.</p>
                            <p>Kraft bags are unique in their ability to carry premium brand artwork while maintaining an inherently natural, unpretentious aesthetic. Full-color printing on kraft paper creates a warm, organic visual effect that synthetic materials simply cannot replicate, making these bags a powerful tool for brands positioned in the natural and artisan market segments.</p>
                            <h3>Advanced Manufacturing Process &amp; Superior Material Quality</h3>
                            <p>The foundation of our <strong>Kraft Bags</strong> lies in premium natural fibrous paper manufacturing. By utilizing virgin or recycled kraft paper in weights from 70gsm to 150gsm+, we guarantee both the natural aesthetic and structural performance your application requires. Advanced kraft lamination and coating technologies add food safety, moisture resistance, and print receptivity without compromising the natural look and feel.</p>
                            <h3>State-of-the-Art Printing Techniques (CMYK &amp; PMS)</h3>
                            <p>Our printing capabilities for <strong>Kraft Bags</strong> are impressive. We utilize advanced flexographic and digital printing processes optimized for natural paper surfaces. Whether you prefer a minimalist one-color logo in soy-based inks or a full-color design that leverages the warm kraft background as a design element, our presses deliver exceptional results that enhance rather than overpower the natural material.</p>
                            <h3>Rigorous Durability Testing and Quality Assurance</h3>
                            <p>Before any packaging leaves our facility, it must pass intensive durability assessments including tensile strength, burst strength, and moisture resistance tests at multiple paper weight specifications. Our kraft bags consistently exceed performance standards across all intended application categories from lightweight retail to heavy grocery and food service use.</p>
                            <h3>Eco-Friendly Benefits &amp; Sustainable Sensibilities</h3>
                            <p>Our <strong>Kraft Bags</strong> are inherently eco-friendly. Kraft paper is biodegradable, compostable, and widely recyclable. We source from FSC-certified forests and offer recycled content options. By choosing our kraft bags, your brand visibly champions environmental stewardship — a differentiator that resonates strongly with eco-conscious consumers and retail partners.</p>
                            <h3>Maximizing Branding Impact and Return on Investment</h3>
                            <p>Investing in custom <strong>Kraft Bags</strong> delivers strong ROI through multiple channels. The natural aesthetic commands premium perceived value, the eco-credentials attract environmentally motivated purchase decisions, and the tactile paper texture creates memorable unboxing experiences — together driving higher customer satisfaction, repeat purchases, and powerful word-of-mouth marketing.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-6 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                        ...
                        <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl overflow-hidden"><img src={FAQimage} alt="Custom Kraft Bags FAQ" className="absolute inset-0 w-full h-full object-cover" /></div>
                    </div>
                </div>
            </section>
            <BrandRating />
