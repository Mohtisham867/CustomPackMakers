...
import heroImg from "@/assets/shape-style/tuck-boxes/straight-tuck-end.webp";
import FAQimage from "@/assets/FAQ-image.webp";

const StraightTuckEnd = () => {
    const [selectedImage, setSelectedImage] = useState(0);

    const productImages = [
        { src: heroImg, alt: "Straight Tuck End Box - Main View" },
        { src: heroImg, alt: "Straight Tuck End Box - Side Angle" },
        { src: heroImg, alt: "Straight Tuck End Box - Open View" },
        { src: heroImg, alt: "Straight Tuck End Box - Detail Shot" },
        { src: heroImg, alt: "Straight Tuck End Box - Lifestyle Shot" },
    ];

    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
            <Helmet>
                <title>Straight Tuck End Boxes | Premium Folding Cartons | CustomPackMakers</title>
                <meta name="description" content="Order wholesale straight tuck end (STE) boxes. The cleanest, most premium structural design for high-end retail packaging. 750+ word expert guide." />
                ...
                <meta property="og:title" content="Straight Tuck End (STE) Boxes | Refined Retail Display" />
                ...
                <div className="container mx-auto px-[30px] py-3">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Straight Tuck End</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Straight Tuck</span> End (STE)
                            </h1>
                        ...
                        <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                                <img src={heroImg} alt="Straight Tuck End Hero" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-8 bg-slate-50 border-t border-slate-100">
                <div className="container mx-auto px-[5vw]">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-tight">
                        Redefining Retail Elegance with Straight Tuck End Engineering
                    </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                        <div className="space-y-6">
                            ...
                            <Accordion type="single" collapsible defaultValue="item-1" className="w-full space-y-2">
                                {[
                                    { id: "item-1", q: "Why choose straight tuck over reverse tuck?", a: "Straight tuck end boxes offer a cleaner aesthetic on the front and side panels because all raw edges are hidden on the back panel. This makes them ideal for luxury retail environments." },
...
export default StraightTuckEnd;
