...
const CandyBags = () => {
    ...
    const productImages = [
        { src: fallbackImage, alt: "Candy Bags - Main View" },
        { src: fallbackImage, alt: "Candy Bags - Angle View" },
        { src: fallbackImage, alt: "Candy Bags - Detail View" },
        { src: fallbackImage, alt: "Candy Bags - Open View" },
        { src: fallbackImage, alt: "Candy Bags - Bottom View" },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Custom</span> Candy Bags
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Discover premium candy bags manufactured precisely to amplify your brand presence. Outstanding durability and print finish for retail and wholesale.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
