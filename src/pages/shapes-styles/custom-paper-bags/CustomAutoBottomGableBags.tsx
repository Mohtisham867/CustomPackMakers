...
import fallbackImage from "@/assets/shape-style/custom-paper-bags/custom-paper-food-bags.webp";
...
const CustomAutoBottomGableBags = () => {
    ...
    const productImages = [
        { src: fallbackImage, alt: "Custom Auto Bottom Gable Bags - Main View" },
        { src: fallbackImage, alt: "Custom Auto Bottom Gable Bags - Angle View" },
        { src: fallbackImage, alt: "Custom Auto Bottom Gable Bags - Detail View" },
        { src: fallbackImage, alt: "Custom Auto Bottom Gable Bags - Open View" },
        { src: fallbackImage, alt: "Custom Auto Bottom Gable Bags - Bottom View" },
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight">
                                <span className="text-primary">Custom</span> Auto Bottom Gable Bags
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">
                                Discover premium custom auto bottom gable bags manufactured precisely to amplify your brand presence. Outstanding durability and print finish for retail and wholesale.
                            </p>
                            <div className="pt-2">
                                <Button
                                    size="lg"
            ...
            <section className="py-8 bg-slate-50">
                <div className="container mx-auto px-[5vw]">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">
                        Industry-Leading Custom Auto Bottom Gable Bags
                    </h2>
                ...
                <div className="container mx-auto px-[5vw]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                        ...
                        <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl overflow-hidden ">
                            <img
                                src={FAQimage}
                                alt="Custom Auto Bottom Gable Bags FAQ"
