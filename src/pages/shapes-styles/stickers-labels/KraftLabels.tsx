...
import heroImg from "@/assets/shape-style/stickers-and-labels/kraft-labels.webp";

const KraftLabels = () => {
  const [selectedImage, setSelectedImage] = useState(0);
  const productImages = [
    { src: heroImg, alt: "Kraft Labels - View 1" },
    { src: heroImg, alt: "Kraft Labels - View 2" },
    { src: heroImg, alt: "Kraft Labels - View 3" },
    { src: heroImg, alt: "Kraft Labels - View 4" },
    { src: heroImg, alt: "Kraft Labels - View 5" },
  ];
  return (
    <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
      <Helmet>
        <title>Custom Kraft Labels | Premium Adhesive Labels | CustomPackMakers</title>
        <meta name="description" content="Order custom Kraft Labels wholesale. Premium adhesive quality, durable finishes, and fast turnaround. Free shipping on bulk orders." />
        <meta name="keywords" content="custom kraft labels, wholesale kraft labels, adhesive labels, custom stickers, label printing" />
        <meta property="og:title" content="Custom Kraft Labels | CustomPackMakers" />
        <meta property="og:description" content="Premium custom kraft labels with durable adhesive, vibrant printing, and specialty finishes. Get a free quote today." />
      </Helmet>
      <Header />
      <div className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 mt-[120px] md:mt-[160px]">
        <div className="container mx-auto px-[30px] py-4">
          <Breadcrumb><BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Kraft Labels</BreadcrumbPage></BreadcrumbItem>
      ...
      <section className="py-8 bg-background">
        <div className="container mx-auto px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight"><span className="text-primary">Custom</span> Kraft Labels</h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">Eco-friendly custom kraft labels featuring natural brown paper aesthetic, biodegradable materials, and organic-style branding for artisan, natural, and sustainable product packaging.</p>
            ...
            <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                <img src={heroImg} alt="Kraft Labels Hero" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-[5vw]">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">Custom Kraft Labels Built for Brands That Demand Quality</h2>
          <p className="text-muted-foreground leading-relaxed text-[15px] max-w-5xl">Our custom kraft labels deliver the authentic, handcrafted aesthetic that artisan food producers, natural cosmetics brands, and eco-conscious product makers depend on to communicate their values at the point of sale. Produced on genuine brown kraft paper with a slightly textured surface, these labels print beautifully in one or multiple colors with a warm, organic quality that mass-market gloss labels cannot replicate. Black, white, and color ink reproduce naturally on the kraft surface, while optional spot varnish adds sheen to selected elements without losing the earthy feel. Kraft labels are biodegradable and compostable, supporting your brand's sustainability story with materials that genuinely reflect your eco values. Available as rectangle, square, oval, round, or custom die-cut shapes on rolls or sheets.</p>
        </div>
      </section>
      ...
      <section className="py-8 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-[5vw]">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-tight">The Complete Guide to Premium Kraft Labels</h2>
        ...
        <div className="container mx-auto px-[30px] relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
            <div className="space-y-5">
              {[
                { color:"primary", path:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", title:"Authentic Natural Aesthetic", body:"Genuine kraft paper delivers an earthy, handcrafted look that resonates with consumers seeking natural, artisan, and organic products. Our kraft labels communicate authenticity and craftsmanship from the first visual impression on retail shelves." },
                { color:"amber-500", path:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z", title:"Biodegradable and Compostable", body:"Our kraft label stock is genuinely biodegradable and compostable, supporting your brand's environmental commitments with materials that match your eco messaging and appeal to the growing segment of sustainability-conscious consumers." },
                { color:"emerald-500", path:"M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z", title:"Versatile Ink Compatibility", body:"Black, white, and full-color inks all print beautifully on kraft paper's natural brown surface. Metallic gold and silver inks create premium contrasts. Spot UV adds selective shine. The result is a label that looks intentionally artisan and elevated." },
              ].map((f,i) => (
                <div key={i}>
            ...
            <div className="relative flex items-center justify-center py-8">
              <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio:'1/1' }}>
                <img src={heroImg} alt="Premium Kraft Labels" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl">
              <img src={heroImg} alt="Differentiate Kraft Labels" className="w-full h-full object-cover" />
            </div>
            <div className="space-y-6 lg:pl-10">
              ...
              <p className="text-base text-slate-600 leading-relaxed max-w-xl">CustomPackMakers kraft labels bring natural integrity to product branding across food, skincare, candles, and lifestyle categories. Our production team understands how color and contrast behave differently on kraft paper versus white stock and adjusts print parameters to deliver artwork that looks intentional and beautiful on the natural surface. Low minimums support small-batch artisan producers and high-volume runs serve established natural brands with consistent seasonal labeling needs.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="space-y-6">
              ...
              <Accordion type="single" collapsible defaultValue="item-1" className="w-full space-y-2">
                {[
                  { id:"item-1", q:"Can kraft labels be waterproof?", a:"Standard kraft labels are not waterproof. We offer water-resistant varnish coatings and waterproof kraft-finish synthetic alternatives that preserve the natural aesthetic while providing moisture resistance for bathroom and food application environments." },
                  { id:"item-2", q:"What colors print well on kraft labels?", a:"Black, dark navy, forest green, and earthy tone inks print vividly on kraft paper. White ink creates high contrast on the brown surface. Bright colors print with a slightly muted, organic quality that most artisan brands find desirable and authentic." },
                  { id:"item-3", q:"Are kraft labels eco-friendly?", a:"Yes. Our kraft labels use natural paper from responsibly managed forests, biodegradable adhesives, and soy-based inks where possible, giving your brand a genuinely sustainable label option supported by FSC certification documentation on request." },
                  { id:"item-4", q:"What shapes are available for kraft labels?", a:"Kraft labels are available in rectangle, square, oval, circle, and custom die-cut shapes. Popular artisan formats include small rectangle hang tags, wide oval jar labels, and square bottle labels for a classic natural product presentation." },
                  { id:"item-5", q:"Do kraft labels work on glass jars?", a:"Yes. Our kraft labels with permanent adhesive bond well to glass jars for candles, food products, and cosmetics. We recommend a water-resistant coating for glass containers used in humid bathroom or kitchen environments to prevent moisture damage." },
                ].map((faq) => (
            ...
            <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl overflow-hidden">
              <img src={FAQimage} alt="Kraft Labels FAQ" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
