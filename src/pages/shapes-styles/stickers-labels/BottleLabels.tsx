...
const BottleLabels = () => {
  ...
  const productImages = [
    { src: heroImg, alt: "Bottle Labels - View 1" },
    { src: heroImg, alt: "Bottle Labels - View 2" },
    { src: heroImg, alt: "Bottle Labels - View 3" },
    { src: heroImg, alt: "Bottle Labels - View 4" },
    { src: heroImg, alt: "Bottle Labels - View 5" },
  ];
  return (
    <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
      <Helmet>
        <title>Custom Bottle Labels | Premium Adhesive Labels | CustomPackMakers</title>
        <meta name="description" content="Order custom Bottle Labels wholesale. Premium adhesive quality, durable finishes, and fast turnaround. Free shipping on bulk orders." />
        <meta name="keywords" content="custom bottle labels, wholesale bottle labels, adhesive labels, custom stickers, label printing" />
        <meta property="og:title" content="Custom Bottle Labels | CustomPackMakers" />
        <meta property="og:description" content="Premium custom bottle labels with durable adhesive, vibrant printing, and specialty finishes. Get a free quote today." />
      </Helmet>
      <Header />
      <div className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 mt-[120px] md:mt-[160px]">
        <div className="container mx-auto px-[30px] py-4">
          <Breadcrumb><BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Bottle Labels</BreadcrumbPage></BreadcrumbItem>
        ...
        <div className="container mx-auto px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight"><span className="text-primary">Custom</span> Bottle Labels</h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-loose max-w-2xl">Durable custom bottle labels featuring waterproof materials, squeeze-resistant construction, and vivid printing for glass, plastic, and metal bottle branding across every industry.</p>
            ...
            <div className="lg:col-span-5 relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-xl shadow-2xl bg-muted group">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200">
                <img src={heroImg} alt="Bottle Labels Hero" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-slate-50">
        <div className="container mx-auto px-[5vw]">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 max-w-3xl">Custom Bottle Labels Built for Brands That Demand Quality</h2>
          <p className="text-muted-foreground leading-relaxed text-[15px] max-w-5xl">Our custom bottle labels are engineered to perform on every bottle type in every environment, from glass wine and spirit bottles chilled in ice buckets to plastic squeeze bottles in busy restaurant kitchens and cosmetic containers in steamy bathrooms. Produced on BOPP polypropylene, polyester, or paper stock with adhesive formulations matched to your specific bottle material and environment, our bottle labels deliver permanent adhesion without bubbling, peeling, or moisture damage. Full-color printing reproduces brand imagery, product information, and regulatory text with precision across narrow wraparound formats and wide panel label designs. We produce front and back labels, wraparound labels, shrink sleeves, and keg labels in any custom dimension for glass, PET, HDPE, aluminum, and stainless steel bottle formats.</p>
        </div>
      </section>
      ...
      <section className="py-8 bg-slate-50 border-t border-slate-100">
        <div className="container mx-auto px-[5vw]">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-tight">The Complete Guide to Premium Bottle Labels</h2>
        ...
        <div className="container mx-auto px-[30px] relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-start">
            <div className="space-y-5">
              {[
                { color:"primary", path:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", title:"Multi-Surface Bottle Adhesion", body:"Our adhesive systems are formulated specifically for glass, PET, HDPE, PP, aluminum, and stainless steel bottle surfaces, ensuring permanent, bubble-free bonding on every substrate your product line uses across applications and environments." },
                { color:"amber-500", path:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z", title:"Waterproof and Squeeze-Resistant", body:"Bottle labels face moisture, condensation, refrigeration, and physical deformation on squeeze bottles. Our waterproof BOPP stock and stress-crack-resistant materials maintain label integrity and appearance through every real-world use scenario your containers encounter." },
                { color:"emerald-500", path:"M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z", title:"Wraparound and Panel Formats", body:"We produce narrow body wraparound labels, front-and-back panel sets, full-circumference wraps, and keg labels in any custom dimension, with precise diameter calculations ensuring a seamless, professional wrap on any cylindrical bottle geometry." },
              ].map((f,i) => (
                <div key={i}>
            ...
            <div className="relative flex items-center justify-center py-8">
              <div className="relative w-full max-w-[480px] rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio:'1/1' }}>
                <img src={heroImg} alt="Premium Bottle Labels" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.5rem] border border-primary/20 shadow-2xl">
              <img src={heroImg} alt="Differentiate Bottle Labels" className="w-full h-full object-cover" />
            </div>
            <div className="space-y-6 lg:pl-10">
              ...
              <p className="text-base text-slate-600 leading-relaxed max-w-xl">CustomPackMakers bottle labels serve brands across beverages, food, cosmetics, cleaning products, pharmaceuticals, and supplements with material expertise that ensures every label performs in its specific environment. Our technical team selects the right substrate and adhesive combination for your bottle material and usage context, from ice-cold beer bottles to chemical-resistant industrial containers, eliminating the guesswork from your label material decision.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="space-y-6">
              ...
              <Accordion type="single" collapsible defaultValue="item-1" className="w-full space-y-2">
                {[
                  { id:"item-1", q:"What bottle materials do your labels adhere to?", a:"Our bottle labels adhere to glass, PET, HDPE, PP, aluminum, and stainless steel surfaces with adhesive formulations specifically selected for each substrate, ensuring permanent bonding without bubble formation or edge lifting on any bottle type." },
                  { id:"item-2", q:"Are your bottle labels waterproof?", a:"Yes. Our BOPP and polyester bottle label stocks are waterproof with laminate coatings that resist direct water exposure, condensation, ice bucket immersion, and humidity, maintaining print quality and adhesion throughout product lifecycle and service conditions." },
                  { id:"item-3", q:"Can bottle labels wrap all the way around a cylindrical bottle?", a:"Yes. We produce full-circumference wraparound bottle labels with precise diameter calculations so the label ends meet cleanly without gap or overlap. Wraparound labels maximize branding real estate on cylindrical bottles of any size or material." },
                  { id:"item-4", q:"Do you produce labels for plastic squeeze bottles?", a:"Yes. Our flexible polypropylene bottle labels stretch and recover with squeeze bottle deformation without cracking or peeling, maintaining adhesion and print appearance even on bottles that are repeatedly compressed during normal dispensing use." },
                  { id:"item-5", q:"What information can be printed on bottle labels?", a:"We print all required product information including brand names, ingredients, nutritional facts, barcodes, QR codes, lot numbers, expiry dates, regulatory warnings, and compliance marks with typographic precision and scannability verified before delivery." },
                ].map((faq) => (
            ...
            <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl overflow-hidden">
              <img src={FAQimage} alt="Bottle Labels FAQ" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
