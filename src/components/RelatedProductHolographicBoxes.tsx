...
const relatedProducts = [
    ...
    { name: "Holographic Bags", image: holographicBags, description: "Premium shiny retail and gift bags featuring eye-catching iridescent effects and durable carrying handles for luxurious presentation.", link: "/box-by-material/holographic-boxes/holographic-bags" },
    { name: "Holographic Foiling Boxes", image: holographicFoilingBoxes, description: "Luxury boxes with stamped holographic foil designed to create a premium, futuristic brand experience and rainbow visual impact.", link: "/box-by-material/holographic-boxes/holographic-foiling-boxes" },
];

export function RelatedProductHolographicBoxes() {
            ...
            <div className="container mx-auto px-[5vw]">
                <div className="mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                        Related Products from Holographic Boxes
                    </h2>
                    <p className="text-lg text-muted-foreground max-w-3xl">
                        Explore our complete range of holographic and iridescent packaging designed to make your brand shine with futuristic rainbow effects.
                    </p>
                </div>
                                            ...
                                            <Card className="overflow-hidden border-border bg-card hover:shadow-xl transition-all duration-300 group cursor-pointer h-full">
                                                <CardContent className="p-0 flex flex-col h-full">
                                                    ...
                                                    <div className="p-5 border-t border-border flex-grow flex flex-col">
                                                        <h3 className="font-semibold text-foreground text-base mb-2 group-hover:text-primary transition-colors">{product.name}</h3>
