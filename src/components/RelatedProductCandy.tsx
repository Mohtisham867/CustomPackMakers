...
const relatedProducts = [
    ...
    { name: "Candy Boxes With Window", image: candyBoxesWindow, description: "Display windows to showcase your colorful candies while maintaining freshness and product protection", link: "/industries/custom-candy-boxes/candy-boxes-with-window" },
