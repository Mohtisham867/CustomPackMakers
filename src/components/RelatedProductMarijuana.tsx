...
export function RelatedProductMarijuana() {
    ...
    return (
        <section className="py-8 bg-accent/20" id="related-products">
            <div className="container mx-auto px-[5vw]">
                <div className="mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                        Related Marijuana Packaging
                    </h2>
                    <p className="text-lg text-muted-foreground max-w-3xl">
                        Explore our complete range of secure, compliant, and stylish packaging designed specifically for the cannabis industry.
                    </p>
                </div>
